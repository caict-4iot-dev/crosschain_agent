...
namespace utils {
	...
	public:
		...
		static std::string GenerateMD5ToHex(const void* dat, size_t len);
		static std::string GenerateMD5ToHex(const std::string &dat);
		static std::string GenerateMD5ToBin(const std::string &dat);

		static std::string GenerateMD5Sum6(const void* dat, size_t len);
		static std::string GenerateMD5Sum6(const std::string &dat);

	private:
		static char hb2hex(unsigned char hb);
		static void md5bin(const void* dat, size_t len, unsigned char *out);
	};
